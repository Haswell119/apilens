...
(function () {
  ...
  function verifyAndStore(key) {
    return fetch('https://apilens-llau.onrender.com/api/verify?key=' + encodeURIComponent(key))
  ...
  function initLicense() {
    ...
    if (sid) {
      ...
      fetch('https://apilens-llau.onrender.com/api/unlock?session_id=' + encodeURIComponent(sid))
        .then(function (r) { return r.json(); })
        .then(function (res) {
          if (res.license_key) {
  ...
  $('btn-buy').addEventListener('click', function () {
    ...
    fetch('https://apilens-llau.onrender.com/api/checkout', { method: 'POST' })
      .then(function (r) { return r.json(); })
      .then(function (res) {
